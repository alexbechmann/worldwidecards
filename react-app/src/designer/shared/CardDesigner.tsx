...
import { ArtistCardDesignControlsContainer } from '@app/designer/artist/ArtistCardDesignControlsContainer';
import { ArtistCardPageContainer } from '@app/designer/artist/ArtistCardPageContainer';
import { ArtistTextControlsContainer } from '@app/designer/artist/ArtistTextControlsContainer';
import { ImageControls } from '@app/designer/shared/controls/ImageControls';
        ...
        <div>
          ...
          <Grid container={true}>
            <Grid item={true} sm={4} xs={12}>
              <ArtistCardDesignControlsContainer />
              <ArtistCardPageContainer
                pageIndex={0}
      ...
      if (editingShape) {
        switch (editingShape.type) {
          ...
          case constants.shapes.types.text: {
            return <ArtistTextControlsContainer />;
          }
          default: {
            return null;
          }
...
export const ArtistCardDesigner: React.ComponentType<Props> = withStyles(styles, { withTheme: true })(
